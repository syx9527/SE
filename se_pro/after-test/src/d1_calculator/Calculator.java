...
public class Calculator {
    ...
    public Calculator() {
        ...
        buttonChu.addActionListener(jt_signal);
        button4.addActionListener(jt);
        button5.addActionListener(jt);
        button6.addActionListener(jt);
        buttonCheng.addActionListener(jt_signal);
        button1.addActionListener(jt);
        button2.addActionListener(jt);
        button3.addActionListener(jt);
        buttonJian.addActionListener(jt_signal);
        button0.addActionListener(jt);
        buttonDian.addActionListener(jt_xs);
        buttonDy.addActionListener(jt_dy);
        buttonJia.addActionListener(jt_signal);
        clearButton.addActionListener(jt_c);
